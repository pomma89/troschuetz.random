...
namespace Troschuetz.Random.Distributions.Continuous
{
    ...
    public sealed class LogisticDistribution : AbstractDistribution, IContinuousDistribution, IMuDistribution<double>, ISigmaDistribution<double>
    {
        ...
        /// </summary>
        public LogisticDistribution() : this(new NumericalRecipes3Q1Generator(), DefaultMu, DefaultSigma)
        {
        ...
        /// </param>
        public LogisticDistribution(uint seed) : this(new NumericalRecipes3Q1Generator(seed), DefaultMu, DefaultSigma)
        {
            Debug.Assert(Generator is NumericalRecipes3Q1Generator);
        ...
        /// </exception>
        public LogisticDistribution(double mu, double sigma) : this(new NumericalRecipes3Q1Generator(), mu, sigma)
        {
            Debug.Assert(Generator is NumericalRecipes3Q1Generator);
