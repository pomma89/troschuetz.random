...
namespace Troschuetz.Random.Distributions.Continuous
{
    ...
    public sealed class PowerDistribution : AbstractDistribution, IContinuousDistribution, IAlphaDistribution<double>, IBetaDistribution<double>
    {
        ...
        /// </summary>
        public PowerDistribution() : this(new NR3Q1Generator(), DefaultAlpha, DefaultBeta)
        {
        ...
        /// </param>
        public PowerDistribution(uint seed) : this(new NR3Q1Generator(seed), DefaultAlpha, DefaultBeta)
        {
            Debug.Assert(Generator is NR3Q1Generator);
        ...
        /// </exception>
        public PowerDistribution(double alpha, double beta) : this(new NR3Q1Generator(), alpha, beta)
        {
            Debug.Assert(Generator is NR3Q1Generator);
